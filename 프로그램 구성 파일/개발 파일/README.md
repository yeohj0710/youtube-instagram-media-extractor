...
YouTube 영상/Shorts 또는 Instagram 릴스/게시물 링크를 넣으면 MP3/MP4 중 원하는 형식으로 빠르게 저장하는 Windows 데스크톱 앱입니다.
...
2. YouTube 영상/Shorts 또는 Instagram 릴스 링크를 붙여넣습니다.
3. 저장 형식을 `MP3` 또는 `MP4`로 선택합니다.
4. 저장 폴더를 확인하거나 `변경`으로 바꿉니다.
5. `빠르게 MP3 추출` 또는 `빠르게 MP4 추출`을 누릅니다.
6. 완료되면 `저장 폴더 열기`로 결과를 확인합니다.
